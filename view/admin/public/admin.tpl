...
<body>
	<div id="header">
		<p>您好, {$smarty.session.user} [{$smarty.session.level_name}] <a target="break" href="?a=index">[去首页]</a> <a href="?a=admin&m=loginOut" onclick="return confirm('确定要退出吗?') ? true : false">[退出]</a></p>
		<ul>
			<li class="first">
